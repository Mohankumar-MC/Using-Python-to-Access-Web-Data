...
Actual data: http://py4e-data.dr-chuck.net/regex_sum_1315723.txt (There are 93 values and the sum ends with 520)
...
result = sum(list(map(int,re.findall('[0-9]+',data))))
print(result)
